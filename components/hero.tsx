          ...
          >
            ...
            >
              <p className="text-lg md:text-xl text-gray-600 mb-8">
                A dynamic digital marketing agency blending creativity, strategy, and technology for measurable brand
                growth.
              </p>
            </motion.div>
          ...
          >
            <div className="relative w-full max-w-md h-[400px] rounded-2xl overflow-hidden shadow-2xl">
              ...
              <div className="absolute bottom-0 left-0 p-6">
                ...
                <h3 className="text-white text-xl font-bold mt-2">Transforming Brands Digitally</h3>
              </div>
            </div>
          </motion.div>
        </div>
